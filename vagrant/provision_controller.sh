...
rm -rf ~/matomo-ansible

# Clone Matomo repository.
git clone https://github.com/UtrechtUniversity/matomo-ansible.git
cd matomo-ansible
git checkout development

# Set file permissions on SSH key to 0600.
chmod 0600 ~/matomo-ansible/vagrant/ssh/vagrant
